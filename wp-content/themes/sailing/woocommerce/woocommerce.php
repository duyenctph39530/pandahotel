...
add_action('woocommerce_checkout_before_order_review_heading', 'before_order_review', 1);
add_action('woocommerce_checkout_after_order_review', 'after_order_review', 90);
