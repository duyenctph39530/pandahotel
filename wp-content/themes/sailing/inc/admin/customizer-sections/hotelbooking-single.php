...
thim_customizer()->add_field(
	array(
		...
		'wrapper_attrs' => array(
			'class' => '{default_class} thim-col-3' . thim_customizer_extral_class( 'single-room' )
		)
	)
);
...
thim_customizer()->add_field(
	array(
		...
		'default' => 'layout-1',
		'wrapper_attrs' => array(
			'class' => '{default_class} thim-col-2' . thim_customizer_extral_class( 'single-room' )
		)
	)
);
...
thim_customizer()->add_field(
	array(
		...
		'section' => 'hb_single',
		'default' => esc_html__( 'Sailing Hotel', 'sailing' ),
		'active_callback' => array(
			array(
				'setting'  => 'thim_top_site_main_layout_custom',
				'operator' => '!=',
