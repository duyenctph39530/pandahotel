...
thim_customizer()->add_field(
	array(
		'id'            => 'thim_desc_blog_tpl',
		'type'          => 'tp_notice',
		'description'   => sprintf( __( 'This page is built by Thim Elementor Kit, you can edit and configure it in %s.', 'sailing' ), '<a href="' . admin_url( 'edit.php?post_type=thim_elementor_kit&thim_elementor_type=archive-post' ) . '" target="_blank">' . __( 'Thim Elementor Kit', 'sailing' ) . '</a>' ),
...
thim_customizer()->add_field(
	array(
		...
		'priority' => 10,
		'wrapper_attrs' => array(
			'class' => '{default_class} thim-col-2' . thim_customizer_extral_class( 'archive-post' )
		)
	)
);
