...
if ( ! function_exists( 'thim_get_option_var_css' ) ) :
	function thim_get_option_var_css() {
		...
		if ( get_theme_mod( 'thim_content_border', false ) == false ) {
...
function thim_scripts() {
	...
	$var_css .= apply_filters( 'thim_custom_internal_css', '' );
	wp_add_inline_style( 'thim-style', $var_css );

	wp_enqueue_style( 'sailing-slick', TP_THEME_URI . 'assets/css/slick.css', array() );

	wp_enqueue_style( 'font-awesome-5-all', TP_THEME_URI . 'assets/css/all.min.css', array(), TP_THEME_VERSION );
	wp_enqueue_style( 'font-awesome-4-shim', TP_THEME_URI . 'assets/css/v4-shims.min.css', array(), TP_THEME_VERSION );
	...
	wp_enqueue_script( 'thim-main', TP_THEME_URI . 'assets/js/main.js', array('imagesloaded'), TP_THEME_VERSION, true );
...
function thim_custom_admin_scripts() {
	...
	wp_enqueue_style( 'thim-admin-font-pe-icon-7', TP_THEME_URI . 'assets/css/font-pe-icon-7.css', array(), TP_THEME_VERSION );
	wp_enqueue_style( 'thim-admin-font-awesome-5-all', TP_THEME_URI . 'assets/css/all.min.css', array(), TP_THEME_VERSION );
	wp_enqueue_style( 'thim-admin-font-awesome-4-shim', TP_THEME_URI . 'assets/css/v4-shims.min.css', array(), TP_THEME_VERSION );
}
...
add_filter( 'get_the_archive_title', 'new_woocommerce_page_title' );
