	...
	if ( $booking->booking_key === $key ) {
		...
		<div class="hb-message message">
			<div class="hb-message-content">
				<?php echo __( 'Cảm ơn bạn! Đặt chỗ của bạn đã được thực hiện. Chúng tôi sẽ liên hệ với bạn để xác nhận đặt chỗ sớm.', 'sailing' ); ?>
			</div>
		</div>
		...
		<div id="booking-items">
			...
			<h3><?php echo __( 'Chi tiết đặt hàng', 'sailing' ); ?></h3>

			<table cellpadding="0" cellspacing="0" class="booking_item_table">
				<thead>
				<tr>
					<th><?php _e( 'Phòng', 'sailing' ); ?></th>
					<th><?php _e( 'Check in - Checkout', 'sailing' ) ?></th>
					<th><?php _e( 'Đêm', 'sailing' ); ?></th>
					<th><?php _e( 'Số lượng', 'sailing' ); ?></th>
					<th><?php _e( 'Tổng', 'sailing' ); ?></th>
				</tr>
				</thead>
				<tbody>
