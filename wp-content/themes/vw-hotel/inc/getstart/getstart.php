    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="vw_hotel_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'vw-hotel' ); ?></button>
		  	...
		  	<button class="tablinks" onclick="vw_hotel_open_tab(event, 'get_bundle')"><?php esc_html_e( 'Get 250+ Themes Bundle at $99', 'vw-hotel' ); ?></button>
		</div>
			...
			<div class="lite-theme-tab" style="<?php echo esc_attr($vw_hotel_plugin_custom_css); ?>">
				...
				<div class="col-right-inner">
	                ...
	                <ul>
	                  	...
	                  	<p><?php esc_html_e(' Once you are done with this, then follow the','vw-hotel'); ?> <a class="doc-links" href="https://preview.vwthemesdemo.com/docs/free-vw-hotel/" target="_blank"><?php esc_html_e('Documentation','vw-hotel'); ?></a></p>
	                </ul>
			  	</div>
			</div>
		</div>
		...
		<div id="hotel_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_HOTEL_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get 250+ Themes Bundle at $99', 'vw-hotel'); ?></a>
				</div>
		    </div>
		...
		<div id="get_bundle" class="tabcontent">		  	
		   <div class="col-left-pro">
		   	<h3><?php esc_html_e( 'WP Theme Bundle', 'vw-hotel' ); ?></h3>
		    	<p><?php esc_html_e('Enhance your website effortlessly with our WP Theme Bundle. Get access to 250+ premium WordPress themes and 5+ powerful plugins, all designed to meet diverse business needs. Enjoy seamless integration with any plugins, ultimate customization flexibility, and regular updates to keep your site current and secure. Plus, benefit from our dedicated customer support, ensuring a smooth and professional web experience.','vw-hotel'); ?></p>
		    	<div class="feature">
		    		<h4><?php esc_html_e( 'Features:', 'vw-hotel' ); ?></h4>
		    		<p><?php esc_html_e('250+ Premium Themes & 5+ Plugins.', 'vw-hotel'); ?></p>
		    		<p><?php esc_html_e('Seamless Integration.', 'vw-hotel'); ?></p>
		    		<p><?php esc_html_e('Customization Flexibility.', 'vw-hotel'); ?></p>
		    		<p><?php esc_html_e('Regular Updates.', 'vw-hotel'); ?></p>
		    		<p><?php esc_html_e('Dedicated Support.', 'vw-hotel'); ?></p>
		    	</div>
		    	<p>Upgrade now and give your website the professional edge it deserves, all at an unbeatable price of $99!</p>
		    	<div class="pro-links">
					<a href="<?php echo esc_url( VW_HOTEL_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'vw-hotel'); ?></a>
					<a href="<?php echo esc_url( VW_HOTEL_THEME_BUNDLE_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'vw-hotel'); ?></a>
				</div>
		   </div>
		   <div class="col-right-pro">
