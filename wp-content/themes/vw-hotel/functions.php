...
function vw_hotel_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="demo-btn"><a href="'. esc_url( 'https://www.vwthemes.net/vw-hotel-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-hotel' ) .'</a></span>';
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wordpress-hotel-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-hotel' ) .'</a></span>';
	echo '</div>';
}
...
//define
define('VW_HOTEL_FREE_THEME_DOC',__('https://preview.vwthemesdemo.com/docs/free-vw-hotel/','vw-hotel'));
...
define('VW_HOTEL_BUY_NOW',__('https://www.vwthemes.com/products/wordpress-hotel-theme','vw-hotel'));
define('VW_HOTEL_LIVE_DEMO',__('https://www.vwthemes.net/vw-hotel-pro/','vw-hotel'));
define('VW_HOTEL_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/vw-hotel-pro/','vw-hotel'));
...
define('VW_HOTEL_CREDIT',__('https://www.vwthemes.com/products/free-wordpress-hotel-theme','vw-hotel'));
