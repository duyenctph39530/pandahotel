...
function bosa_hotel_modify_default_settings( $wp_customize ){

	$wp_customize->get_setting( 'blogname' )->transport = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport = 'postMessage';

}
add_action( 'customize_register', 'bosa_hotel_modify_default_settings' );

if( !function_exists( 'bosa_hotel_hex2rgba' ) ):
/**
* Convert hexdec color string to rgb(a) string
*/
function bosa_hotel_hex2rgba($color, $opacity = false) {
...
function bosa_hotel_default_styles(){
	...
	$site_primary_color = get_theme_mod( 'site_primary_color', '#C9A76E' );
	$site_hover_color = get_theme_mod( 'site_hover_color', '#E4A853' );
	...
	$top_header_text_link_hover_color = get_theme_mod( 'top_header_text_link_hover_color', '#E4A853' );
	$sub_menu_link_hover_color = get_theme_mod( 'sub_menu_link_hover_color', '#E4A853' );
	$css .= '
	...
	$mid_header_text_link_hover_color = get_theme_mod( 'mid_header_text_link_hover_color', '#E4A853' );
	$css .= '
		.mid-header .overlay {
	...
	$bottom_header_text_link_hover_color = get_theme_mod( 'bottom_header_text_link_hover_color', '#E4A853' );
	$css .= '
	...
	$css .= '
		...
		.header-fourteen .bottom-contact {
			border-color: '. esc_attr( bosa_hotel_hex2rgba( $bottom_header_text_color, 0.1 ) ).';
		}
	...
	$top_hover_color_transparent_header = get_theme_mod( 'top_hover_color_transparent_header', '#E4A853' );
	...
	$content_hover_color_transparent_header = get_theme_mod( 'content_hover_color_transparent_header', '#E4A853' );
	...
	$the_custom_logo_url = bosa_hotel_get_custom_logo_url();
	if( $the_custom_logo_url == ''  && ( get_theme_mod( 'header_layout', 'header_fourteen' ) !== 'header_two' || ( !is_front_page() && ( get_theme_mod( 'disable_transparent_header_post', true ) && !is_single() ) && ( get_theme_mod( 'disable_transparent_header_page', true ) && !is_page() ) ) || empty( get_theme_mod( 'header_separate_logo', '' ) ) ) ){
		$css .= '
	...
	if ( get_theme_mod( 'main_slider_controls', 'slider' ) == 'slider' ){
		...
		$separate_hover_color_for_main_slider = get_theme_mod( 'separate_hover_color_for_main_slider', '#E4A853' );
		$css .= '
	...
	$top_footer_widget_link_hover_color = get_theme_mod( 'top_footer_widget_link_hover_color', '#E4A853' );
	$css .= '
		.top-footer {
	...
	$css .= '
		...
		.widget ul li,
		.latest-posts-widget .post {
			border-bottom-color: '. esc_attr( bosa_hotel_hex2rgba( $top_footer_widget_link_color, 0.2 ) ).';
		}
	...
	$bottom_footer_text_link_hover_color = get_theme_mod( 'bottom_footer_text_link_hover_color', '#E4A853' );
	$css .= '
		.bottom-footer {
	...
	$css .= '
		.site-footer .social-profile ul li a {
			background-color: '. esc_attr( bosa_hotel_hex2rgba( $bottom_footer_text_link_color, 0.1 ) ).';
		}
	';
    ...
    $blog_post_category_color = get_theme_mod( 'blog_post_category_color', '#C9A76E' );
    $blog_post_meta_color = get_theme_mod( 'blog_post_meta_color', '#7a7a7a' );
    $blog_post_meta_icon_color = get_theme_mod( 'blog_post_meta_icon_color', '#C9A76E' );
    $blog_post_text_color = get_theme_mod( 'blog_post_text_color', '#333333' );
    $blog_post_hover_color = get_theme_mod( 'blog_post_hover_color', '#E4A853' );
	...
	$featured_post_category_bgcolor = get_theme_mod( 'featured_post_category_bgcolor', '#C9A76E' );
    ...
    $featured_post_hover_color = get_theme_mod( 'featured_post_hover_color', '#E4A853' );
    $css .= '
    ...
    $highlight_post_meta_icon_color = get_theme_mod( 'highlight_post_meta_icon_color', '#C9A76E' );
    $highlight_post_hover_color = get_theme_mod( 'highlight_post_hover_color', '#E4A853' );
    $css .= '
    	...
    	.highlight-layout-two .highlight-post-slider .post .cat-links a {
    		border-bottom-color: '. esc_attr( bosa_hotel_hex2rgba( $highlight_post_category_color, 0.5 ) ).';
    	}
	...
	// Sale Tag Colors
	$sale_tag_bg_color = get_theme_mod( 'sale_tag_bg_color', '#C9A76E' );
	...
	if( get_theme_mod( 'disable_mobile_promotions', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	# Responsive Occasions
	if( get_theme_mod( 'disable_mobile_occasion', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	# Responsive Facts
	if( get_theme_mod( 'disable_mobile_facts', false ) ){
		$css .='
			@media screen and (max-width: 767px){
				.section-facts-area {
	    			display: none;
	...
	# Responsive Facts
	if( get_theme_mod( 'disable_mobile_followers', false ) ){
		$css .='
			@media screen and (max-width: 767px){
...
add_action( 'wp_head', 'bosa_hotel_default_styles' );