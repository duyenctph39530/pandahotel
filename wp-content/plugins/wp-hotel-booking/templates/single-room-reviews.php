...
<div id="reviews">
    ...
    <div id="comments">
                ...
                <div class="gallery-filter">
                    ...
                    <a class="<?php echo $photos_only === 'yes' ? 'active' : ''; ?>"
                       href="<?php echo add_query_arg( array(
						   'photos_only' => 'yes',
						   'tab'         => 'review'
					   ), $link ); ?>"><?php esc_html_e( 'Chỉ có hình ảnh', 'wp-hotel-booking' ); ?></a>
                </div>
                <div class="sort-by">
		...
		<?php } else { ?>
            <p class="hb-noreviews"><?php _e( 'Chưa có đánh giá nào.', 'wp-hotel-booking' ); ?></p>
		<?php } ?>
    </div>
	...
	<?php } else { ?>
        <p class="hb-verification-required"><?php _e( 'Chỉ những khách hàng đã đăng nhập và mua sản phẩm này mới có thể đưa ra đánh giá.', 'wp-hotel-booking' ); ?></p>
	<?php } ?>
